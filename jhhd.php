...
<body >
    ...
    <div align="center" style="width:660px">
     <div id="homepic1" style="background:url(images/renais.jpg)">
        <p class="message_hsss" align="left" >
		 	 ...
		 	 <font color="#FF6600"> <a href="http://westcoastchristianconference.com/"> <font color="#FF0000"><strong><blink>2015年WCCC美加西岸特会</blink><br/></strong></font></a>
		 	 <a href="fyay.php"><font color="#FF0000"><strong><blink>本教会2015年度秋季退修会</blink></strong></font></a><br/> 欢迎弟兄姊妹参加！</font></p>
     </div>       
 ...
 <?php  $conn = @mysql_connect("50.63.231.66","mess","Christ!1225"); 
    ...
    <h2>最近活动更新</h2> 
     <p>
      <a href="jhhdvplay.php?vid=<? echo $result[vid];?>"> <? echo $result[title];?>
<video id="sampleMovie"  width="640" height="360" autoplay controls poster="video/<? echo $result[picname];?>">
...
Your browser does not support the video tag.
      ...
      <p>&nbsp;</p>
            ...
            <div id="shipinlan">
					...
					<?
                    $i=1;
					while(($result = mysql_fetch_array($check_query))&& ($i<=36)){
                    echo '<div class="manu_boxs" ><a href="jhhdvplay.php?vid='.$result[vid].'">
					
					<img src="phpThumb/phpThumb.php?src=../video/'.$result[picname].'&w=140&h=79" width="140" height="79" style="overflow:hidden"/>
					</a>';
				...
				while($result = mysql_fetch_array($pa_query)){
				 ...
				 echo '<div class="manu_boxs"><a href="picdisplay.php?paid='.$result[papath].'&pid='.$pic_result[ppath].'"><img src="phpThumb/phpThumb.php?src=../pictures/'.$result[papath].'/'.$pic_result[ppath].'&w=140&h=79" width="140" height="79" style="overflow:hidden"/></a>';
				  if(!$pic_result[ptitle]) $pic_result[ptitle]=$pic_result[ppath];
                   ...
                   echo '<p><a href="padisplays.php?paid='.$result[papath].'&pid='.$pic_result[ppath].'">'.$result[patitle].'</p></div>';
                  } ?> 
	...
	<div id="footer">
     ...
     <div align="center"><font face="Arial"><?  echo '欢迎来基督荣耀教会网站，教会活动栏目，您是本网页'.date("Y").'年第<font color="#FF0000">'.file_get_contents($filepath).'</font>位访客';?></font></div><font face="Arial">
