...
<body >
    ...
    <div align="center" style="width:660px">
     <div id="homepic1" style="background:url(images/renais.jpg)">
        <p class="message_hsss" align="left" >
		 	 ...
		 	 <font color="#FF6600"> <a href="fyay.php"> <font color="#FF0000"><strong><blink>2014年圣诞福音聚会预告</blink>:<br/>
 ...
 <?php  $conn = @mysql_connect("50.63.231.66","mess","Christ!1225"); 
 			...
 			$result = mysql_fetch_array($check_query); 
				?>
     <p> <a href="jhhdvplay.php?vid='.$result[vid].'">
      ...
      <p>&nbsp;</p>
            ...
            <div id="shipinlan">
                    ...
                    echo '<div class="manu_boxs" ><a href="jhhdvplay.php?vid='.$result[vid].'"><img src="video/'.$result[picname].'" /></a>';
