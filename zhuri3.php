...
<br/>
  ...
  <source src="video/<?php echo $result[flv]; ?>" type="video/mp4">
  <source src="video/<?php echo $result[flv]; ?>" type="video/ogg">
  <source src="video/<?php echo $result[flv]; ?>" type="video/flv">
 </video>
