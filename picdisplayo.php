...
<?php
 ...
 $conn = @mysql_connect("picdate.db.8559606.hostedresource.com","picdate","Christ!1225"); 
			...
			<h2><?php if (!$result[patitle])$result[patitle]=$paid; echo $result[patitle];?></h2>
               ...
               <p>       <?php echo '<img src="pictures/'.$paid.'/'.$pid.'" />';?>     </p>                 	
				 
                  
               <p>  <a href=<?php echo '"picdisplay2.php?paid='.$paid.'&pid='.$pid.'"';?> >两倍尺寸</a>&nbsp;
				  <a href=<?php echo '"picdisplay.php?paid='.$paid.'&pid='.$pid.'"';?> >一倍尺寸</a> &nbsp;
